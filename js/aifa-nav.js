(function () {
  ...
  var navMarkup = [
    ...
    '        <div class="aifa-nav-dropdown">',
    '          <a href="https://go.aifusionautomations.com/ai-office-hours-page">AI Office Hours</a>',
    '          <a href="/webinars/transforming-your-work-replay.html">AI Workflow Webinar Replay</a>',
    '        </div>',
    '      </li>',
